...
INSERT INTO collection (short_name, full_name, source, img_url, "language", order_by, direction)  VALUES ('English', 'English', 'filter', 'collection/shdm.jpg', 'ENG', 'date', 'DESC');