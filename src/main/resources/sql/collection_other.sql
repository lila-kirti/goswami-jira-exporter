...
INSERT INTO collection (short_name, full_name, source, img_url)  VALUES ('Публичные лекции', 'Публичные лекции', 'collection', 'collection/publics.jpg');
...
INSERT INTO collection (short_name, full_name, source, img_url, "language", order_by, direction)  VALUES ('Школа джапа-медитации', 'Школа джапа-медитации', 'filter', 'collection/shdm.jpg', 'ENG', 'date', 'DESC');