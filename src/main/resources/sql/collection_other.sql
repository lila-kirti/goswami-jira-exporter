...
INSERT INTO collection (short_name, full_name, source, img_url, order_by, direction, ordern)  VALUES ('Школа джапа-медитации', 'Школа джапа-медитации', 'filter', 'collection/shdm.jpg', 'date', 'DESC', 9);
...
INSERT INTO collection (short_name, full_name, source, img_url, "language", order_by, direction, ordern)  VALUES ('English', 'English', 'filter', 'collection/english.jpg', 'ENG', 'date', 'DESC', 10);
